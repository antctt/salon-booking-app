  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden text-foreground">
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        <header className="bg-background/40 text-white backdrop-blur-md supports-[backdrop-filter:blur(0px)]:bg-background/5">
        ...
        <footer className="bg-background/40 py-10 text-white backdrop-blur-md supports-[backdrop-filter:blur(0px)]:bg-background/5">
